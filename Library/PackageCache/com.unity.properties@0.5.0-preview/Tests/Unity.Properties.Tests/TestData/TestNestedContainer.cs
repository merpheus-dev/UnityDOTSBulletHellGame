namespace Unity.Properties.Tests
{
    ...
    {
        private readonly UnmanagedProperty<TestNestedContainer, TestPrimitiveContainer> m_TestContainer = new UnmanagedProperty<TestNestedContainer, TestPrimitiveContainer>(
