namespace Unity.Properties.Tests
{
    ...
    {
        private readonly ArrayProperty<TestArrayContainer, int> m_Int32Array = new ArrayProperty<TestArrayContainer, int>(
        ...
        private readonly ArrayProperty<TestArrayContainer, TestPrimitiveContainer> m_TestStructArray = new ArrayProperty<TestArrayContainer, TestPrimitiveContainer>(
