namespace Unity.Properties.Tests
{
    ...
    {
        private static readonly ValueProperty<CustomDataFoo, int> s_Test = new ValueProperty<CustomDataFoo, int>(
        ...
        private static readonly ValueProperty<CustomDataFoo, int> s_Foo = new ValueProperty<CustomDataFoo, int>(
    ...
    {
        private static readonly ValueProperty<CustomDataBar, int> s_Test = new ValueProperty<CustomDataBar, int>(
        ...
        private static readonly ValueProperty<CustomDataBar, int> s_Bar = new ValueProperty<CustomDataBar, int>(
