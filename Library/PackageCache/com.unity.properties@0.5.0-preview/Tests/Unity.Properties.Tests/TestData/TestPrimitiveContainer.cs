...
namespace Unity.Properties.Tests
{
    ...
    {
        private readonly UnmanagedProperty<TestPrimitiveContainer, bool> m_BoolValue = new UnmanagedProperty<TestPrimitiveContainer, bool>(
            nameof(TestPrimitiveContainer.BoolValue),
            0);

        private readonly UnmanagedProperty<TestPrimitiveContainer, sbyte> m_Int8Value = new UnmanagedProperty<TestPrimitiveContainer, sbyte>(
            nameof(TestPrimitiveContainer.Int8Value),
            1);

        private readonly UnmanagedProperty<TestPrimitiveContainer, short> m_Int16Value = new UnmanagedProperty<TestPrimitiveContainer, short>(
            nameof(TestPrimitiveContainer.Int16Value),
            2);

        private readonly UnmanagedProperty<TestPrimitiveContainer, int> m_Int32Value = new UnmanagedProperty<TestPrimitiveContainer, int>(
            nameof(TestPrimitiveContainer.Int32Value),
            4);

        private readonly UnmanagedProperty<TestPrimitiveContainer, long> m_Int64Value = new UnmanagedProperty<TestPrimitiveContainer, long>(
            nameof(TestPrimitiveContainer.Int64Value),
            8);

        private readonly UnmanagedProperty<TestPrimitiveContainer, byte> m_UInt8Value = new UnmanagedProperty<TestPrimitiveContainer, byte>(
            nameof(TestPrimitiveContainer.UInt8Value),
            16);

        private readonly UnmanagedProperty<TestPrimitiveContainer, ushort> m_UInt16Value = new UnmanagedProperty<TestPrimitiveContainer, ushort>(
            nameof(TestPrimitiveContainer.UInt16Value),
            17);

        private readonly UnmanagedProperty<TestPrimitiveContainer, uint> m_UInt32Value = new UnmanagedProperty<TestPrimitiveContainer, uint>(
            nameof(TestPrimitiveContainer.UInt32Value),
            20);

        private readonly UnmanagedProperty<TestPrimitiveContainer, ulong> m_UInt64Value = new UnmanagedProperty<TestPrimitiveContainer, ulong>(
            nameof(TestPrimitiveContainer.UInt64Value),
            24);

        private readonly UnmanagedProperty<TestPrimitiveContainer, float> m_Float32Value = new UnmanagedProperty<TestPrimitiveContainer, float>(
            nameof(TestPrimitiveContainer.Float32Value),
            32);

        private readonly UnmanagedProperty<TestPrimitiveContainer, double> m_Float64Value = new UnmanagedProperty<TestPrimitiveContainer, double>(
